    ...
    $('#BatchForm').submit(function (event) {
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                document.getElementById('metrics-display').style.fontSize = '20px';
                document.getElementById('metrics-display').style.color = '#2e4c8c';
...
document.getElementById("submit&NextBtn").style.margin = "15px";
...
function collectData() {
    ...
    for (let i = 1; i <= rows.length; i++) {
        ...
        const rowData = {
            ...
            "Address Component": cells[2].querySelector("select").value
        };
        dicData[i] = cells[2].querySelector("select").value;
