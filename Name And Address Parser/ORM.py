...
class ExceptionTable(Base):
    ...
    __table_args__ = (
        PrimaryKeyConstraint('UserName','Timestamp','Run', 'Address_ID', 'Component', 'Component_index'),
    )
...
#     ComponentTable(component="USAD_ANM", description="Secondary Address Name"),
#     ComponentTable(component="USAD_ANO", description="Secondary Address Number"),
